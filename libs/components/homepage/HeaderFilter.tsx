						...
						{propertyLocation.map((location: string) => {
							return (
								<div onClick={() => propertyLocationSelectHandler(location)} key={location}>
									<img src={`img/banner/city/${location}.avif`} alt="" />
									<span>{location}</span>
								</div>
							);
						})}
					...
					<Box sx={style}>
						<Box className={'advanced-filter-modal'}>
									...
									<div className={'box'}>
										...
										<div className={'inside'}>
											<FormControl>
												...
												>
													<MenuItem value={'all'}>Hotel</MenuItem>
													<MenuItem value={'propertyBreakfast'}>Penthouse</MenuItem>
													<MenuItem value={'propertyCancellation'}>Resort Vilas</MenuItem>
												</Select>
											</FormControl>
										</div>
									</div>
							...
							<div className={'bottom'}>
								...
								<Button
									startIcon={<img src={'/img/icons/search_white.svg'} />}
