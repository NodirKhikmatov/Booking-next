								...
								<Stack className={'left-box'}>
									...
									<Stack className={'top-box'}>
										...
										<Stack className={'buy-rent-box'}>
											{property?.propertyBreakfast && (
												<>
													<Stack className={'circle'}>
														<svg
															stroke="currentColor"
															fill="rgb(12, 188, 135)" // Set fill color directly
															strokeWidth="0"
															viewBox="0 0 16 16"
															height="1em"
															width="1em"
													...
													<Typography className={'buy-rent'}>Free Breakfast</Typography>
												</>
											)}

											{property?.propertyCancellation && (
												<>
													<Stack className={'circle'}>
														<svg
															stroke="currentColor"
													...
													<Typography className={'buy-rent'}>Free Cancellation</Typography>
												</>
											)}
										</Stack>
										<Stack className={'divider'}></Stack>
										...
										<Stack className="option" direction="row" alignItems="center" spacing={1}>
											<div
												style={{
													...
													WebkitMask: 'url(/img/icons/bed.png) no-repeat center / contain',
													mask: 'url(/img/icons/bed.png) no-repeat center / contain',
												}}
											/>
										...
										<Stack className="option" direction="row" alignItems="center" spacing={1}>
											<div
												style={{
													...
													height: '24px',
													backgroundColor: 'rgb(170, 132, 83)',
													WebkitMask: 'url(/img/icons/room.png) no-repeat center / contain',
													mask: 'url(/img/icons/room.png) no-repeat center / contain',
												}}
											/>
										...
										<Stack className="option" direction="row" alignItems="center" spacing={1}>
											<div
												style={{
													...
													height: '24px',
													backgroundColor: 'rgb(170, 132, 83)',
													WebkitMask: 'url(/img/icons/bathroom.png) no-repeat center / contain',
													mask: 'url(/img/icons/bathroom.png) no-repeat center / contain',
												}}
											/>
										...
										<Stack className="option" direction="row" alignItems="center" spacing={1}>
											<div
												style={{
													...
													height: '24px',
													backgroundColor: 'rgb(170, 132, 83)',
													WebkitMask: 'url(/img/icons/expand.svg) no-repeat center / contain',
													mask: 'url(/img/icons/expand.svg) no-repeat center / contain',
												}}
											/>
											<Typography>
										...
										<Stack className={'info-box'}>
											<Stack className={'left'}>
												...
												<Box component={'div'} className={'info'}>
													...
													<Typography className={'data'}>{property?.propertyBathroom}</Typography>
												</Box>
											</Stack>
